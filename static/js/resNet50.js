    ...
    $('#btn-predict-ResNet50').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#resultResNet50").attr("src","data:image/png;base64,"+ data.image);
                $('#text50').html("Number of bboxes "+data.box+'<br>Time '+data.time)
                // $("#resultResNet50").attr("src","data:image/gif;base64," + data);
            },
        });
    });
